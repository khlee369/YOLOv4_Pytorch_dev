...
def train(model, device, config, epochs=5, batch_size=1, save_cp=True, log_step=20, img_scale=0.5):
    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img', ncols=50) as pbar:
            ...
            detect.detect_img(model, img_path, 'prediction_{}.jpg'.format(global_step))
            ...
            for i, batch in enumerate(train_loader):
                ...
                if global_step % config.subdivisions == 0:
                    ...
                    # eval_stats = coco_evaluator.evaluate(model, device)
                    detect.detect_img(model, img_path, 'prediction_sample.jpg')
...
def get_args(**kwargs):
    ...
    parser.add_argument('-weights', '--weights', type=str, default='/workspace/GitHub/YOLO/yolov4.weights', help='/path/to/yolov4.weights')
